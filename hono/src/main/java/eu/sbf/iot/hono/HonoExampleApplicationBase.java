...
public class HonoExampleApplicationBase {
	    ...
	    private void printMessage(final String tenantId, final Message msg, final String messageType) {
	        if (LOG.isDebugEnabled()) {
	            ...
	            final String location = content.substring(2, content.indexOf("/"));
	            final String parameter = content.substring(content.indexOf("/")+1, content.indexOf(":")-1);
	            final Double value = Double.parseDouble(content.substring(content.indexOf(":")+1, content.length()-1));
	            ...
	            params.add(new BasicNameValuePair("l", location));
	            params.add(new BasicNameValuePair("p", parameter));
	            params.add(new BasicNameValuePair("v", Double.toString(value)));
	            try {
